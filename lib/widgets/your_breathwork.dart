...
class YourBreathwork extends StatefulWidget {
  final String? videoLink;
  final String? videoId;
  final String? videoTitle;
  final String? videoThumbnail;

  const YourBreathwork(
      {Key? key,
      this.videoLink,
      this.videoId,
      this.videoThumbnail,
  ...
  @override
  State<YourBreathwork> createState() => _YourBreathworkState();
}

class _YourBreathworkState extends State<YourBreathwork> {
